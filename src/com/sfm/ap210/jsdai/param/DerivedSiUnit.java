...
public class DerivedSiUnit implements Unit {
	...
	public String toString()
	{
		...
		for (SiUnitTerm t : terms) {
			if (t.exponent != 1) {
				s += t.siunit.toString() + t.exponent;
	 ...
	 */
	public static class ThermalResistanceUnit extends DerivedSiUnit {

		public ThermalResistanceUnit() {
			super();
		}

		public ThermalResistanceUnit(SiBase b1, int e1, SiBase b2, int e2,
				SiBase b3, int e3) {
			super(b1, e1, b2, e2, b3, e3);
		}
		...
		public ThermalResistanceUnit(SiBase b, int e, SiPrefix p) {
			super(b, e, p);
		}

		public ThermalResistanceUnit(SiBase b, int e) {
			super(b, e);
		}

		public ThermalResistanceUnit(SiUnitTerm... terms) {
			super(terms);
		}
