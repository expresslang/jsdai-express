...
public  AFunctional_unit  All_fu_referencing_pdf (EProduct_definition_formation e1) throws SdaiException  {
	
	System.out.println("");
	System.out.println("\tAll_fu_referencing_pdf");
	System.out.println("\tGiven: "+e1.toString());
		
	AFunctional_unit a_referencing = new AFunctional_unit();
	 AFunctional_unit a_return = new AFunctional_unit();
	CFunctional_unit.usedinFormation(null, (EProduct_definition_formation)e1, null, a_referencing);	
	
	SdaiIterator it_entities = a_referencing.createIterator();
	while (it_entities.next()) 
	{
		EFunctional_unit e_return = (EFunctional_unit) a_referencing.getCurrentMemberEntity(it_entities);
...
public  AFunctional_unit_terminal_definition  All_futd_referencing_fu (EFunctional_unit e1) throws SdaiException  {
	
	System.out.println("");
	System.out.println("\tAll_futd_referencing_fu");
	System.out.println("\tGiven: "+e1.toString());
		
	AFunctional_unit_terminal_definition a_referencing = new AFunctional_unit_terminal_definition();
	 AFunctional_unit_terminal_definition a_return = new AFunctional_unit_terminal_definition();
	CFunctional_unit_terminal_definition.usedinOf_shape(null, (EFunctional_unit)e1, null, a_referencing);	
	
	SdaiIterator it_entities = a_referencing.createIterator();
	while (it_entities.next()) 
	{
		EFunctional_unit_terminal_definition e_return = (EFunctional_unit_terminal_definition) a_referencing.getCurrentMemberEntity(it_entities);
...
public  ANetwork_node_definition All_nnd_relatedTo_fu_through_pdr (EFunctional_unit e1, String v1) throws SdaiException {
	
	System.out.println("");
	System.out.println("\tAll_nnd_relatedTo_fu_through_pdr('"+v1+"')");
	System.out.println("\tGiven: "+e1.toString());
	
	AProduct_definition_relationship a_relationship = new AProduct_definition_relationship();
	 ANetwork_node_definition a_return = new ANetwork_node_definition();
	CProduct_definition_relationship.usedinRelating_product_definition(null, (EFunctional_unit)e1, null, a_relationship);
	SdaiIterator it_entities = a_relationship.createIterator();
	while (it_entities.next()) 
	{
		...
		if ((e_relationship.testName(null)) && (e_relationship.getName(null).equals(v1)))
		{
			...
			EEntity e2 = e_relationship.getRelated_product_definition(null);
			if (e2.isKindOf(ENetwork_node_definition.class))
			{
			ENetwork_node_definition e_return = (ENetwork_node_definition) e2;
...
public  AProperty_definition  All_pd_referencing_cfu (EComponent_functional_unit e1) throws SdaiException  {
	
	System.out.println("");
	System.out.println("\tAll_pd_referencing_cfu");
	System.out.println("\tGiven: "+e1.toString());
		
	AProperty_definition a_referencing = new AProperty_definition();
	 AProperty_definition a_return = new AProperty_definition();
	CProperty_definition.usedinDefinition(null, (EComponent_functional_unit)e1, null, a_referencing);	
...
public  AProperty_definition  All_pd_referencing_nnd (ENetwork_node_definition e1) throws SdaiException  {
	
	System.out.println("");
	System.out.println("\tAll_pd_referencing_nnd");
	System.out.println("\tGiven: "+e1.toString());
		
	AProperty_definition a_referencing = new AProperty_definition();
	 AProperty_definition a_return = new AProperty_definition();
	CProperty_definition.usedinDefinition(null, (ENetwork_node_definition)e1, null, a_referencing);	
...
public  AProduct_definition_formation  All_pdf_referencing_p (EProduct e1) throws SdaiException  {
	
	System.out.println("");
	System.out.println("\tAll_pdf_referencing_p");
	System.out.println("\tGiven: "+e1.toString());
		
	AProduct_definition_formation a_referencing = new AProduct_definition_formation();
	 AProduct_definition_formation a_return = new AProduct_definition_formation();
...
public EFunctional_unit fu_relatedTo_cfu_through_pdr (EComponent_functional_unit e1, String v1) throws SdaiException {
	
	System.out.println("");
	System.out.println("\tfu_relatedTo_cfu_through_pdr('"+v1+"')");
	System.out.println("\tGiven: "+e1.toString());
	
	AProduct_definition_relationship a_relationship = new AProduct_definition_relationship();
	
	CProduct_definition_relationship.usedinRelated_product_definition(null, (EComponent_functional_unit)e1, null, a_relationship);
	SdaiIterator it_entities = a_relationship.createIterator();
	while (it_entities.next()) 
	{
		EProduct_definition_relationship e_relationship = (EProduct_definition_relationship) a_relationship.getCurrentMemberEntity(it_entities);
		if ((e_relationship.testName(null)) && (e_relationship.getName(null).equals(v1)))
		{
			...
			if (e2.isKindOf(EFunctional_unit.class))
			{
			EFunctional_unit e_return = (EFunctional_unit) e2;
...
public EFunctional_unit fu_relatedTo_fu_through_pdr (EFunctional_unit e1, String v1) throws SdaiException {
	
	System.out.println("");
	System.out.println("\tfu_relatedTo_fu_through_pdr('"+v1+"')");
	System.out.println("\tGiven: "+e1.toString());
	
	AProduct_definition_relationship a_relationship = new AProduct_definition_relationship();
	
	CProduct_definition_relationship.usedinRelated_product_definition(null, (EFunctional_unit)e1, null, a_relationship);
	SdaiIterator it_entities = a_relationship.createIterator();
	while (it_entities.next()) 
	{
		EProduct_definition_relationship e_relationship = (EProduct_definition_relationship) a_relationship.getCurrentMemberEntity(it_entities);
...
public EFunctional_unit fu_relatedTo_fu_through_pdr_2 (EFunctional_unit e1, String v1) throws SdaiException {
	
	System.out.println("");
	System.out.println("\tfu_relatedTo_fu_through_pdr_2('"+v1+"')");
	System.out.println("\tGiven: "+e1.toString());
...
public EFunctional_unit_terminal_definition futd_relatedTo_cft_through_sar (EComponent_functional_terminal e1, String v1) throws SdaiException {
	
	System.out.println("");
	System.out.println("\tfutd_relatedTo_cft_through_sar('"+v1+"')");
	System.out.println("\tGiven: "+e1.toString());
	
	AShape_aspect_relationship a_relationship = new AShape_aspect_relationship();
	
	CShape_aspect_relationship.usedinRelated_shape_aspect(null, (EComponent_functional_terminal)e1, null, a_relationship);
	SdaiIterator it_entities = a_relationship.createIterator();
	while (it_entities.next()) 
	{
		EShape_aspect_relationship e_relationship = (EShape_aspect_relationship) a_relationship.getCurrentMemberEntity(it_entities);
		if ((e_relationship.testName(null)) && (e_relationship.getName(null).equals(v1)))
		{
			...
			EEntity e2 = e_relationship.getRelating_shape_aspect(null);
			if (e2.isKindOf(EFunctional_unit_terminal_definition.class))
			{
			EFunctional_unit_terminal_definition e_return = (EFunctional_unit_terminal_definition) e2;
...
public EProperty_definition pd_relatedTo_pd_through_pdr_3 (EProperty_definition e1, String v1) throws SdaiException {
	
	System.out.println("");
	System.out.println("\tpd_relatedTo_pd_through_pdr_3('"+v1+"')");
	System.out.println("\tGiven: "+e1.toString());
	
	AProperty_definition_relationship a_relationship = new AProperty_definition_relationship();
	
	CProperty_definition_relationship.usedinRelating_property_definition(null, (EProperty_definition)e1, null, a_relationship);
	SdaiIterator it_entities = a_relationship.createIterator();
	while (it_entities.next()) 
	{
		EProperty_definition_relationship e_relationship = (EProperty_definition_relationship) a_relationship.getCurrentMemberEntity(it_entities);
