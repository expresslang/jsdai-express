...
public class MIMqueriesDebugImpl implements MIMqueries {
	...
	*/
	...
	@Override
	public AProduct_definition_formation getAllVersionsOfProduct(EProduct e_p)
			throws SdaiException {
		outputGivenDebugInfo(e_p);
		AProduct_definition_formation a_pdf = q.getAllVersionsOfProduct(e_p);
		outputReturnDebugInfo(a_pdf);
		return a_pdf;
	}
}
