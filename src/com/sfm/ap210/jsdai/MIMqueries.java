...
public interface MIMqueries {
	...
	public AProduct_definition_formation getAllVersionsOfProduct(EProduct e_p) throws SdaiException;
	...
	/**
	 * Returns a 'ppsm' {@MIM shape_representation} ({@ARM Planar_projected_shape_model}) for a {@MIM _shape} directly related through a {@MIM shape_definition_representation}. 
